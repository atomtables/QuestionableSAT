...
{#if numberSelected() > 0}
    <div class="bg-blue-400 text-gray-800 py-2 px-1 flex flex-row items-center justify-between" transition:slide>
...
{/if}
<table class="bg-blue-900 w-full text-left">
    <thead>
...
{#if source.length < 1}
    <div class="bg-blue-900 p-2 w-full text-center">
        {emptyStr}
    </div>
{/if}